    ...
    <view class="content-main">
      ...
      <view class="content-box-top woo-box-flex">
        <view class="content-box-avatar">
          <u-image shape="circle" width="50px" height="50px" :src="handleUrl()(contentObj.params.avatar)">
          </u-image>
        </view>
      ...
      <view class="content-feed-content" style="padding-left: 60px; margin: 0px 10px 0 0">
        <view class="content-feed-ogText" @click="clickContent()">
          <!-- 文字 -->
          <view v-html="contentObj.content" style="white-space: pre-wrap"></view>
        </view>
        <!-- 信息墙的图片/视频 -->
        <view style="margin-top: 10px">
          <ContentFile v-if="contentObj.type != 0" :fileUrls="contentObj.fileUrl" :contentType="contentObj.type">
          </ContentFile>
        </view>
      </view>
    </view>
...
export default {
  ...
  methods: {
    ...
    //判断是否被点赞
    isZan(contentId) {
      this.zanBoolean = Array.isArray(this.loveContentIds) && this.loveContentIds.includes(contentId)
    }
